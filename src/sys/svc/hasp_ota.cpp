...
// Declare the companion end pointer generated by the linker for this specific file
...
void otaSetup(void)
{
    ...
    // Calculate the size in bytes by subtracting the start memory address from the end address
...
#else
    // Legacy Core v2 signature only wants the start pointer
